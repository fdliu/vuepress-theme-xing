...
module.exports = {
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '关于', link: '/about/' },
      { text: 'Github', link: 'https://github.com/fdliu/lzx-vuepress' },
    ],
    ...
    //*** 以下是Vdoing主题相关配置，文档：https://doc.fdliu.com/pages/a20ce8/ ***//
    ...
    // 社交图标，显示于博主信息栏和页脚栏。内置图标：https://doc.fdliu.com/pages/a20ce8/#social
    social: {
    ...
    footer: {
      ...
      copyrightInfo:
        'Xing Kong| <a href="https://github.com/fdliu/vuepress-theme-xing/" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
  ...
  plugins: [
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'fe2fd274555c456b2c81',
          clientSecret: 'b736aa7c1c66d16acce5bf07070793e94641a098',
          repo: 'vuepress-theme-xing', // GitHub 仓库
          owner: 'fdliu', // GitHub仓库所有者
          admin: ['fdliu'], // 对仓库有写权限的人
